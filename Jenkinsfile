...
def upstreamProjects = [
  ...
  // No Jenkins: <groupId>com.sendmail</groupId><artifactId>jilter</artifactId>
  // No Jenkins: <groupId>org.apache.logging.log4j</groupId><artifactId>log4j-1.2-api</artifactId>

  // Runtime Direct
  // No Jenkins: <groupId>org.apache.logging.log4j</groupId><artifactId>log4j-jul</artifactId>
]
